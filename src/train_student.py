...
def main():
    ...
    print(f"\nTraining Student baseline for {epochs} epochs...")
    ...
    print(f"\nStudent baseline training complete!")
    print(f"Best validation accuracy: {best_acc:.2f}%")
    print(f"Final test accuracy: {test_acc:.2f}%")
    print(f"Model saved to: artifacts/student_fp32.pt")
